...
function AiExplanation({ code, token }) {
    ...
    useEffect(() => {
        ...
        fetch(`/api/v1/insurance/codes/${code}`, {
    ...
    if (error) {
        return (
            <div style={{ fontFamily: mono, fontSize: "0.66rem", color: "#666672" }}>
                Code not found in database. Ask your provider for a written description.
            </div>
        );
    }
...
export default function CodePopup({ item, token, onClose }) {
    ...
    const severityColor = {
        ...
        MEDIUM: "#f0d0a8",
        LOW: "#a8f0c6",
    }[item.flagReason?.includes("PRICE") ? "HIGH" : "MEDIUM"] ?? "#f0d0a8";
            ...
            <div
                ...
                style={{
                    ...
                    boxShadow: item.flagged
                        ? "0 40px 100px -20px rgba(255,40,40,0.2), 0 0 0 1px rgba(255,80,80,0.08)"
            ...
            >
                ...
                <div style={{
                    ...
                    background: item.flagged
                        ...
                        : "linear-gradient(90deg, transparent, rgba(168,240,198,0.4), transparent)",
                }} />
                ...
                <div style={{
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: "0.7rem" }}>
                        ...
                        <button
                            ...
                            onMouseLeave={e => { e.currentTarget.style.background = "rgba(255,255,255,0.06)"; e.currentTarget.style.color = "#666672"; }}
                        >
                            ✕
                        </button>
                    </div>
                ...
                <div style={{ padding: "1.2rem 1.8rem", display: "flex", flexDirection: "column", gap: "1.2rem" }}>
                    ...
                    <div style={{ display: "flex", gap: "0.6rem" }}>
                        ...
                        <StatPill
                            label="Line Total"
                            value={fmt(item.lineTotal)}
                            accent={item.flagged ? "#ff9999" : "#fff"}
                        />
                        {item.reimbursementEligible && (
                            <StatPill label="Reimbursable" value="Yes" accent="#a8f0c6" />
                        )}
                    </div>
                    ...
                    {item.description && (
                        <div>
                            ...
                            <div style={{ fontSize: "0.86rem", color: "#b0b0bc", lineHeight: 1.6 }}>
                                {item.description}
                            </div>
                        </div>
                    )}
                    ...
                    {item.reimbursementEligible && (
                        <div style={{
                            ...
                            <div>
                                <div style={{ fontSize: "0.8rem", fontWeight: 600, color: "#a8f0c6", marginBottom: "0.15rem" }}>
                                    Reimbursement Eligible
                                </div>
                                <div style={{ fontFamily: mono, fontSize: "0.6rem", color: "#668877", letterSpacing: "0.06em" }}>
                                    You may be owed {fmt(item.lineTotal)} for this charge
                                </div>
                            </div>
                        </div>
                    )}
